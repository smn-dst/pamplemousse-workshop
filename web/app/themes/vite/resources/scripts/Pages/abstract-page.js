   ...
   */
    initBlocks()
    {
        for (let i = 0; i < blockList.length; i++) {
            const foundBlocks = this.view.querySelectorAll('.blocks .' + blockList[i].name);
   ...
   */
    initComponents()
    {
        for (let i = 0; i < componentList.length; i++) {
            const foundComponents = this.view.querySelectorAll('.' + componentList[i].name);
            ...
            for (let j = 0; j < foundComponents.length; j++) {
                const componentInstance = new componentList[i].Class(foundComponents[j]);
                const instance = {
